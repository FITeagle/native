$.jStorage.set('profile', {
	...
	'connection' : {
		'http://fiteagleinternal' : {
			description : {
				en : 'FITeagle Internal'
			},
			...
			examples : [{
				...
				uri : 'http://fiteagleinternal%23ARunningMotor101',
				label : 'Running Motor 101'
			}, {
				uri : 'http://fiteagleinternal%23ADeployedMotorAdapter1',
				label : 'Motor Garage 1'
			}
			]
		},
		'http://fiteagle.org' : {
			...
			examples : [{
				...
				uri : 'http://fed4fire.eu/resources#fp',
				label : 'FUSECO Playground'
			}]
		},
		'http://fed4fire.eu' : {
			description : {
