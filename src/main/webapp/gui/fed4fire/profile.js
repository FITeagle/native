...
$.jStorage.set('profile', {
    ...
    'connection' : {
        'urn:,http:' : {
            ...
            endpoint : 'http://demo.fiteagle.org:8080/openrdf-sesame/repositories/fed4fire',
            endpointType : 'sesame',
            examples : [{
                label : 'Fed4FIRE Federation',
                uri : 'http://fed4fire.eu/about%23federation'
            },
            {
                label : 'iMinds Federation Member',
                uri : 'http://iminds.be/about%23organization'
            },
            {
                label : 'Virtual Wall 2 Testbed',
                uri : 'http://wall2.ilabt.iminds.be/about%23infrastructure'
            }]
        },
    },
    arrows : {
